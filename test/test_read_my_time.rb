...
class TestReadMyTime < MiniTest::Test
  ...
  def test_return_word_minutes_and_seconds
    assert_equal('1 minute 40 seconds', (1.minute + 40.seconds).seconds_in_words)
  end

  def test_return_only_word_minutes
    assert_equal('1 minute', (1.minute + 40.seconds).seconds_in_words(skip_seconds: true))
  end

  def test_return_word_hours
    assert_equal('1 hour 1 minute 40 seconds', (1.hour + 1.minute + 40).seconds_in_words)
  end
